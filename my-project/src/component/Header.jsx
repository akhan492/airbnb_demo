      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mx-auto bg-inherit">
          ...
          <div className="flex items-center  mb-4">
            <h5 className="text-2xl flex-grow font-semibold">
              Number of Guest
            </h5>
            <BiUser />
            <input type="number" value={noOfGuest} min={0} onChange={e=>setNumberOfGuest(e.target.value)} className="outline-none w-10 text-red-400 text-lg pl-2" />
          </div>
